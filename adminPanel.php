...
<div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
        ...
        <div class="d-flex pl-3">
            <a href="parser.php" onclick="load(); return false;" id="parser" class="btn btn-outline-dark bg-info mx-3">Parse News</a>
...
<div id="spinner" class="d-flex justify-content-center text-primary d-none" style="min-height: 100vh; align-items: center; background-color: rgba(,0,255,.1)">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button"  onclick="document.querySelector('.modal').classList.remove('show')" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>The parser has finished work</p>
            </div>
            <div class="modal-footer">
                <button type="button" onclick="document.querySelector('.modal').classList.remove('show')" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
